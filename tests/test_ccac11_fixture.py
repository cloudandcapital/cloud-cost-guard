...
CHECKER_PATH = REPOSITORY_ROOT / "scripts" / "validate_ccac11_fixture.py"
FIXTURE_PATH = REPOSITORY_ROOT / "fixtures" / "ccac" / "illustrative-v0.3.0" / "run"

SPEC = importlib.util.spec_from_file_location("validate_ccac11_fixture", CHECKER_PATH)
